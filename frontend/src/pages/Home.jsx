...
const Home = () => {
  ...
  return (
    <div className="bg-white text-white dark:text-white dark:bg-black ">
      ...
      {/* Services Section */}
      <div className="relative overflow-hidden bg-[#120E23]">
      
      <section className="text-center px-4 mt-20 mb-28 bg-[#120E23] overflow-x-hidden">
      ...
      A team of skilled professionals committed to quality, innovation, and measurable impact.            </p>
        ...
        {/* Testimonials */}
        <section className="relative px-4 pb-20 mt-20 z-10 bg-[#120E23] overflow-hidden">
          <div className="relative max-w-6xl mx-auto text-center mb-16">
        ...
        {/* FAQ */}
        <section className="relative px-4 pb-24 z-10 bg-[#120E23] overflow-hidden">
